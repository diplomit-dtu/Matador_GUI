...
import desktop_codebehind.Observable;
...
public final class GUI_Car extends Observable {
    ...
    private void repaint(){
        ...
        switch(this.pattern) {
            ...
            default: throw new RuntimeException( "Engine failure! - Car doesn't work.");
        }
    }
    ...
    static {
        patternImages.put(Pattern.DIAGONAL_DUAL_COLOR, "/desktop_resources/structures/Diag_dual.png");
