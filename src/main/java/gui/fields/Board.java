 ...
 * @author Ronnie
 */
public final class Board extends javax.swing.JFrame implements Observer {
    ...
    private static void generateSquareBoard(int sideLength) {
        ...
        for(int x=sideLength; x > 0; x--){
            Board.points[i++] = new Point(x+offSet, sideLength+offSet);
        }
        for(int y=sideLength; y > 0; y--){
            Board.points[i++] = new Point(0+offSet, y+offSet);
        }
        for(int x=0; x < sideLength; x++){
            Board.points[i++] = new Point(x+offSet, 0+offSet);
        }
        for(int y=0; y < sideLength; y++){
            Board.points[i++] = new Point(sideLength+offSet, y+offSet);
        }
    }
    ...
    public Board(Field[] fields, Color backGroundColor) {
        ...
        this.setTitle(Attrs.getString("Board.Title"));
        ...
        playerList = new Player[MAX_PLAYER_COUNT];
    ...
    private void makeDice() {
        try {
            URL path = Attrs.getImagePath("Board.Dice");
    ...
    private void makePlayerAreas() {
        ...
        for(int i = 0; i < MAX_PLAYER_COUNT; i++) {
            ...
            this.factory.setSize(playerLabel, nameLabelSize * Field.FIELDWIDTH, 1 * Field.FIELDWIDTH);
     ...
     * needs to be updated.
     */
    private void carPositionChanged(Car car, Field oldPosition, Field newPosition){
    ...
    /**
     * Utility method to check if this Board contains the given Field
     */
    public boolean hasField(@NotNull Field field){
        for( Field match : fields ){
    ...
    /**
     * @return  Returns the Player whose car is the given car, or null if no Player owns this car
     */
    public Player getCarOwner(Car car) {
